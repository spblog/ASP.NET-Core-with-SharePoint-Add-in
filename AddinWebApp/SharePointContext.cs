...
namespace AddinWebApp
{
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public static RedirectionStatus CheckRedirectionStatus(HttpContext httpContext, out Uri redirectUrl)
        {
            ...
            Uri requestUrl = new Uri(httpContext.Request.GetDisplayUrl());

	        var queryNameValueCollection = Microsoft.AspNetCore.WebUtilities.QueryHelpers.ParseQuery(httpContext.Request.GetEncodedPathAndQuery());
